   ...
   local skullflower = {
    ...
    local necroblight = {
        ...
        MainRotation = function()
            ...
            if DKROT:CanUse("Blood Tap") and bloodCharges >= 5 and DKROT:CanSoulReaper(true) then
                return "Blood Tap"
            end
            ...
            -- DnD
            if DKROT:CanUse("Death and Decay") and DKROT:isOffCD("Death and Decay") and unholy == 0 then
