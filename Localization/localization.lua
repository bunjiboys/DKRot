if select(2, UnitClass("player")) == "DEATHKNIGHT" then
   ...
   DKROT_OPTIONS_DT_THREAT_BARS = "Bars"
   DKROT_OPTIONS_DT_THREAT_HATED = "Only when hated"
   DKROT_OPTIONS_DT_THREAT_HEALTH = "Show Health Bars"
   DKROT_OPTIONS_DT_DOTS = "Track DOTs"
   DKROT_OPTIONS_DT_TRANS = "Backdrop Opacity"
   ...
   DKROT_OPTIONS_POSITION_SCALE = "Scale"
   DKROT_OPTIONS_POSITION_POINT = "Frame Point"
   DKROT_OPTIONS_POSITION_REL_FRAME = "Anchor To"
